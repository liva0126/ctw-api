package ctw.user.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import ctw.base.utils.RegexUtils;
import ctw.user.annotation.AuthCheck;
import ctw.base.common.BaseResponse;
import ctw.base.common.DeleteRequest;
import ctw.base.common.ErrorCode;
import ctw.base.common.ResultUtils;
import ctw.base.constant.UserConstant;
import ctw.base.exception.BusinessException;
import ctw.base.exception.ThrowUtils;
import ctw.user.model.dto.UserAddRequest;
import ctw.user.model.dto.UserLoginRequest;
import ctw.user.model.dto.UserQueryRequest;
import ctw.user.model.dto.UserRegisterRequest;
import ctw.user.model.dto.UserUpdateMyRequest;
import ctw.user.model.dto.UserUpdateRequest;
...
import ctw.wxmp.config.WxOpenConfig;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        long result = userService.userRegister(account, password, checkPassword, gender);
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        LoginUserVO loginUserVO = userService.userLoginByPassword(account, password, request);
    ...
    public BaseResponse<String> userLoginByPhoneCode(@RequestBody UserLoginRequest userLoginRequest,
            HttpServletRequest request) {
        if (userLoginRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        String token = userService.userLoginByPhone(userLoginRequest, request);
